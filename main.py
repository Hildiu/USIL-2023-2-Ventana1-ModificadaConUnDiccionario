...
#Paso 4. Vemos que en Pycharm aparece el archivo VentanaSecundaria.ui, si hacemos clic sobre él y presionamos shift + Enter
...
class VentanaSecundaria(QDialog):
    def __init__(self, d,  parent=None):
        ...
        self.lineTalla = self.findChild(QLineEdit,"lineEdit_3")
        self.linePeso  = self.findChild(QLineEdit,"lineEdit_4")
    ...
    def funcionesClick(self):
        ...
        talla = float(self.lineTalla.text())
        peso  = int(self.linePeso.text())
        d[nombre] = {"edad":edad, "talla":talla, "peso":peso}  #-- insertando un elemento al diccionario
       ...
       # print("Almacenamos los datos en una lista", lista)
        ...
        print(d)   #--- se imprime el diccionario en la consola
...
if __name__ == "__main__":
    ...
    d = {}   #-- iniciando un diccionario
    win = VentanaSecundaria(d)
    win.show()
    sys.exit(app.exec_())
